...
public class AdminUpsert extends HttpServlet {

    private static final Logger LOG = Logger.getLogger(AdminUpsert.class.getName());
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res){
        ...
        try {
            ...
            AdminVO admin = new AdminForm().validateAdmin(payload);

            IAdapter adapter = (IAdapter) Manager.Instance().create(provider);
            adapter.upsertAdmin(admin);
