...
import com.zebrands.mx.framework.messaging.Twiliox;
...
public class Mongo implements IAdapter {
    ...
    public void upsertProduct(ProductVO p) throws CustomException {
        ...
        try {
            ...
            if (docQuery == null) {
                ...
                for (AdminVO admin:
                     list) {
                    Twiliox.sendSMS(admin.getPhone(), "Hola "+admin.getName()+", sku["+p.getSku()+"] fue modificado");
                }
