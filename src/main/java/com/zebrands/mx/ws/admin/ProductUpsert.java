...
public class ProductUpsert extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res){
        ...
        try {
            ...
            String invoker = req.getHeader("Authorization");
            LOG.log(Level.INFO, "invoker=> "+invoker);

            ProductVO p = new ProductForm().validateProduct(payload, invoker);

            IAdapter adapter = (IAdapter) Manager.Instance().create(provider);
            adapter.upsertProduct(p);
